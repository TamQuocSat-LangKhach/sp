```lua
local hulao__shenwei = fk.CreateSkill {
  name = "hulao__shenwei"
}
...
-- 触发技效果
hulao__shenwei:addEffect(fk.DrawNCards, {
...
-- 最大手牌上限技能效果
hulao__shenwei:addEffect('maxcards', {
  correct_func = function(skill, player)
  if player:hasSkill(hulao__shenwei.name) then
